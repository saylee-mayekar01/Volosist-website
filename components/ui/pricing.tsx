...
type PricingFrequencyToggleProps = React.HTMLAttributes<HTMLDivElement> & {
	frequency: FREQUENCY;
...
export function BorderTrail({
  ...
  // Fix: Explicitly cast 'ease' to 'const' to ensure it's treated as a valid Easing literal type rather than a generic string.
